...
- O workflow agendado deve permanecer aos sábados às 08:00 e às quartas-feiras às 17:00 no Horário de Brasília (`America/Sao_Paulo`), implementado como `cron: '0 11 * * 6'` e `cron: '0 20 * * 3'` porque GitHub Actions agenda em UTC, salvo instrução expressa do proprietário.
