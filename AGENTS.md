...
- O workflow semanal deve permanecer aos sábados às 08:00 no Horário de Brasília (`America/Sao_Paulo`), implementado como `cron: '0 11 * * 6'` porque GitHub Actions agenda em UTC, salvo instrução expressa do proprietário.
